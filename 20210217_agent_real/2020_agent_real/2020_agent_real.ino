...
#include "hero_msgs/hero_yolo_cont.h"
...
void messageCont_YOLO(const hero_msgs::hero_yolo_cont &yolo_msg)
{
...
ros::Subscriber<hero_msgs::hero_yolo_cont> sub_yolo_msg(
    "/hero_agent/yolo", &messageCont_YOLO);
