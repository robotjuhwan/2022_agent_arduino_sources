...
#include "ros_opencv_track/hero_track_msg.h"
...
void messageCont_TRACK(const ros_opencv_track::hero_track_msg &track_msg)
{
  object_x = track_msg.x;
  object_y = track_msg.y;
}
...
ros::Subscriber<ros_opencv_track::hero_track_msg> sub_track_msg(
    "/hero_track_msg", &messageCont_TRACK);
